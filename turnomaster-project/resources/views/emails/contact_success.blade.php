...
<head>
    ...
    <title>Mensaje enviado exitosamente | TurnoMaster</title>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Gracias por contactar al soporte de TurnoMaster, {{ $name }} {{ $last_name }}</h1>
            <p>
                Tu mensaje ha sido enviado exitosamente y nuestro equipo de soporte se pondrá en contacto contigo a la brevedad.
            </p>
            <p style="font-size: 14px; color: #AAAAAA; margin-top: 25px;">
                Si no realizaste una solicitud, por favor ignora este correo.
            </p>
        </div>
        <div class="footer">
