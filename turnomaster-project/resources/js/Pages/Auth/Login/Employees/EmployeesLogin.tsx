...
import { FaEye, FaEyeLowVision, FaUserTie } from "react-icons/fa6";
...
const EmployeesLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post("/api/login-employees", {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center">
                ...
                <Link to="/auth/forgot-password/employees" className="text-sm hover:underline">
