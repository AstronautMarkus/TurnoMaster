...
const ReportsIndex: React.FC = () => {
    return (
        <div className="p-6">
            <h1 className="text-3xl sm:text-4xl font-bold text-left mb-6 mt-4">
                <FaBullhorn className="inline-block mr-2" />
                TurnoMaster - Asistencia y Reportes</h1>
                ...
                <div className="flex-grow bg-white shadow-md sm:p-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="bg-gray-50 p-4 shadow-sm flex flex-col gap-4 border border-gray-200">
                            ...
                            <Link to="/dashboard/reports/turnos/register" className="dashboard-button text-white bg-blue-600 hover:bg-blue-700 p-3 flex items-center gap-3 transition-colors">
                                <FaClipboardCheck className="text-2xl" />
                                <span>Registrar asistencia</span>
                            </Link>
                            <Link to="/dashboard/reports/turnos/review" className="dashboard-button text-white bg-blue-500 hover:bg-blue-600 p-3 flex items-center gap-3 transition-colors">
                        ...
                        <div className="bg-gray-50 p-4 shadow-sm flex flex-col gap-4 border border-gray-200">
                            <h2 className="text-xl font-semibold mb-2 flex items-center gap-2">
                                <FaExclamationTriangle className="text-yellow-500" /> Reportes y justificación de peticiones
                            </h2>
                            <p className="text-gray-600 text-sm mb-2">
